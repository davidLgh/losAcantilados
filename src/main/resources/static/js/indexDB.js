...
async function cargarCategoriasHtml() {
  ...
  for (let categoria of categorias) {
      /*CATEGORIA HTM*/
      if (categoria.nombre != ""){
        let categoriaHtml = '<div class="col-xs-12 col-sm-6 clase-cat"><div class="menu-section" id="('+categoria.id+')" value="('+categoria.id+')"><h2 class="menu-section-title">' + categoria.nombre + '</h2> <hr><div id="productoCat'+categoria.id+'" class="menu-item"></div></div></div>'
